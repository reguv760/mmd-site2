      ...
      <div className="pageContainer teacherPage">
        ...
        <div className="pageContainer right">
          <div className="homeText">
            ...
            <br />
            <p>
              Someone who imparts the knowledge or skill of quality, production,
              expression, or realm, according to aesthetic principles, of what
            ...
            >
              Download Art Instruction PDF - 3MB
            </a>
            <br />>{' '}
            <a
              href={PrivateLesson}
              ...
              rel="noopener noreferrer"
            >
              Download Private Lessons PDF - 0.5MB
            </a>
          </div>
        </div>
        <div className="blackBorder" />
