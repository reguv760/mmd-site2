...
const SRS_IMAGE = [{ id: '1', src: SRSfull, thumbnail: SRSthumb }];
      ...
      <Layout>
        ...
        <div className="pageContainer advertPage">
          ...
          <div className="pageContainer right">
            <Gallery
              images={CC_IMAGES.map(({ id, src, thumbnail }) => ({
                src,
                thumbnail
              }))}
            />
            ...
            <Gallery
              images={GH_IMAGES.map(({ id, src, thumbnail }) => ({
                src,
                thumbnail
              }))}
            />
            ...
            <Gallery
              images={PUMA_IMAGES.map(({ id, src, thumbnail }) => ({
                src,
                thumbnail
              }))}
            />
            ...
            <Gallery
              images={PUMP_IMAGES.map(({ id, src, thumbnail }) => ({
                src,
                thumbnail
              }))}
            />
            ...
            <Gallery
              images={SRS_IMAGE.map(({ id, src, thumbnail }) => ({
                src,
                thumbnail
              }))}
            />
            ...
            <Gallery
              images={STJ_IMAGES.map(({ id, src, thumbnail }) => ({
                src,
                thumbnail
              }))}
            />
